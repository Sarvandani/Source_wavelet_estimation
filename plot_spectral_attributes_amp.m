function plot_spectral_attributes(t0,w,dt,fmax,N);
...
% Plot Amplitue and Phase
   ...
   figure, plot(f,A,'b', 'LineWidth',6);     xlabel('Frequency [Hz]'); ylabel('Ampitude')
                 axis([0,fmax,0,1.1])
                 grid;

%    figure, plot(f,Theta); xlabel('Frequency [Hz]'); ylabel('Phase [Deg]')
